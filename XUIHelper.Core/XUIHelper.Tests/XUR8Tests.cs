...
namespace XUIHelper.Tests
{
    public class XUR8Tests : XURTests
    {
        ...
        //TODO: Add a parent class VECTSection for VECT5Section, VECT8Section that implements build. Do this for QUAT too that writes the same between XUR5 and XUR8.
